			...
			<form @submit="formSubmit" @reset="formReset">
				<view class="uni-list">
					...
					<view class="uni-list-cell">
						...
						<view class="uni-list-cell-db">
							<text style="display: block;" class="uni-input">{{ gbzt }}</text>
						</view>
					</view>
					<view class="uni-list-cell" v-if="!mjjc">
						...
						<view class="uni-list-cell-db">
							<input class="uni-input" type="text" name="jc" :placeholder="lang.enterAccessCount" :value="jc"></input>
						</view>
					</view>
				</view>
				<view class="uni-padding-wrap">
					<view class="uni-btn-v">
						<button name="btn_cksh" :disabled="dis" type="primary" class="btn-setstorage" form-type="submit">
							{{lang.reportMark}}
						</button>
					</view>
				</view>

		...
		<view class="uni-common-mt">
			<view class="uni-list">
				...
				<view class="uni-list-cell">
					...
					<view class="uni-list-cell-db">
						<input class="uni-input" type="text" @input="cphInput" :placeholder="lang.platePlaceholder" name="jkzl"  
				...
				<view class="uni-list-cell">
					...
					<view class="uni-list-cell-db">
						<input class="uni-input" @input="vinInput" type="text" :placeholder="lang.vinPlaceholder" name="vin"  
			...
			<view class="uni-padding-wrap">
				<view class="uni-btn-v">
					<button name="btn_select" type="default" class="btn-setstorage" @tap="select">{{ lang.queryButton }}</button>
					<button name="btn_insert" type="primary" class="btn-setstorage" @tap="insert">{{ lang.bindButton }}</button>
					<button name="btn_reset" type="warn" class="btn-setstorage" @tap="getempty">{{ lang.clearButton }}</button>
				</view>
			</view>
		</view>
	</view>

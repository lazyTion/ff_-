				...
				<view class="uni-list">
					<view class="uni-list-cell">
						...
						<view class="uni-list-cell-db">
							<input class="uni-input input-text" type="text" :placeholder="lang.enterCarNumber" name="ch" :value="ch"
								@input="chChange"></input>
					</view>
							<view class="uni-label">{{lang.applicationReason}}</view>
							<input class="uni-input input-text" type="text" name="bz" :placeholder="lang.requiredField" :value="bz"
	...
	export default {
		...
		data() {
			return {
				...
				currentLang: 'zh', // 当前语言
				lang: zh ,// 语言资源对象
				languageClass: 'lang-zh lang-transition page-cheliang'
			}
		onLoad: function(options) {
			var that = this;
	   this.currentLang = uni.getStorageSync('lang') || 'zh';
	   	this.lang = this.currentLang === 'zh' ? zh : ru;
			this.languageClass = getLanguageClass(this.currentLang, 'page-cheliang');
		console.log(lang);
